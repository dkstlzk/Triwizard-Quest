...
int main(void){
    ...
    while (!WindowShouldClose() && currentscreen != EXIT) {
        ...
        switch (currentscreen){
            ...
            case TRANSITION:
                if (lastgame == 1) {
                    DrawText("Dragon Task", 240, 180, 30, ORANGE);
            ...
            case END:
                if (game1won && game2won && game3won){
                    ...
                    if (IsKeyPressed(KEY_ENTER)){
                        game1won= game2won= game3won= false;
                        lastgame= 0;
                        lastgamewon= false;
                        currentscreen= MENU;
                    }
                    ...
                    DrawText(game1won ? "1. Dragon Game: Won" : "1. Dragon Game: Lost", 200, 300, 20, game1won ? GREEN : RED);
                    DrawText(game2won ? "2. Snitch Escape: Won" : "2. Snitch Escape: Lost", 200, 330, 20, game2won ? GREEN : RED);
                    DrawText(game3won ? "3. Enchanted Maze: Won" : "3. Enchanted Maze: Lost", 200, 360, 20, game3won ? GREEN : RED);
